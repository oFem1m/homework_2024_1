...
QUnit.module('Тестируем функцию inverse', function () {
    ...
    QUnit.test('Функция выбрасывает null при передаче не массива', function (assert) {
        assert.deepEqual(inverse('не массив'), null);
    });

    QUnit.test('Функция выбрасывает null при передаче некорректного второго аргумента', function (assert) {
